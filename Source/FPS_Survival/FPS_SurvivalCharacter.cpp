...
void AFPS_SurvivalCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Triggered, this, &AFPS_SurvivalCharacter::HealthInteract);
		//Shooting
...
void AFPS_SurvivalCharacter::HealthInteract()
{
	UE_LOG(LogTemp, Warning, TEXT("INTERACTING HEALTH"));
	//Ensure player can interact
	if(m_bCanInteractHealth)
	{
